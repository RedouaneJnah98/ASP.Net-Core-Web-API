        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "The one that is in Belgium.", "Antwerp" },
                    { 3, "The one with that big port between Morocco and Spain.", "Tangier City" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The most visited central park in the world.", "Central Park" },
                    { 2, 1, "A 102-story skyscraper located in Midtown Manhattan.", "Empire State Building" },
                    { 3, 3, "Is the big port in Africa, and one of the biggest in the world.", "Big Port" }
                });
